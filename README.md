...
The useRouteMatch hook is useful any time you are using a <Route> just so you can get access to its match data, including all of the times you might render a <Route> all by itself

2. How would you explain form validation to someone who has never programmed before?
it is a way to validate what a user is typing in to make sure it matches what you are looking for.
